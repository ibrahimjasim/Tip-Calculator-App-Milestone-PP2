...
## Table of Contents:
+ [UX](#ux)
  + [Site Purpose](#sites-purpose---key-project-goals-and-target-audience)
+ [Design](#design)
...
### Bugs
- [x] your UI comes off the page below 460px. 
- [x] your app breaks under the condition that if you adjust the tip/split prior to entering a number, then when you enter a number no 
  calculation is formed until you adjust the tip/split again
